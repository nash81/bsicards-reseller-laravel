...
use App\Http\Middleware\BypassTransMiddleware;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Keep `trans` middleware alias as a no-op to bypass license validation reliably.
        $this->app->booted(function () {
            $this->app->make(Router::class)->aliasMiddleware('trans', BypassTransMiddleware::class);
        });
    }
}
