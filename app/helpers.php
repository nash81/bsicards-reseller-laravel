...
if (!function_exists('bsi_api_endpoint')) {

    function bsi_api_endpoint(): string {
        return rtrim((string) config('services.bsi_cards.api_endpoint', ''), '/');
    }

}

if (!function_exists('bsi_merchant_api_url')) {

    function bsi_merchant_api_url(?string $endpoint = null): string {
        $base = bsi_api_endpoint();
