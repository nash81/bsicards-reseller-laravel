    ...
    <div class="nav-wrap">
        ...
        <div class="nav-right">
            ...
            <div class="single-nav-right">
                <a href="{{ route('home') }}" target="_blank" class="item" data-bs-toggle="tooltip" title="Visit Landing Page"
            ...
            <div class="single-nav-right">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li class="logout">
                        <a href="{{ url('admin/logout') }}" class="dropdown-item text-danger" type="button"
