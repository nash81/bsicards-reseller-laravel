            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <form action="{{route('admin.plan.fdr.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="site-card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="text" name="intervel" class="form-control" />
                                    ...
                                    <div class="col-xl-6" id="maturity-platform-fee-sec">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text"  name="maturity_platform_fee" oninput="this.value = validateDouble(this.value)" class="form-control" />
                                                <span class="input-group-text">{{ setting('site_currency','global') }}</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        {{-- FDR Return section hidden --}}
                        <div class="site-card" style="display: none;">
                            <div class="site-card-header">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="switch-field same-type">
                                                <input type="radio" id="radio-seven" name="is_compounding" checked="" value="1" disabled />
                                                <label for="radio-seven">{{ __('Compounding') }}</label>
                                                <input type="radio" id="radio-eight" name="is_compounding" value="0" disabled />
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="switch-field same-type">
                                                <input type="radio" id="radio-can-add" name="is_add_fund_fdr" checked="" value="1" />
                                                <label for="radio-can-add">{{ __('Enable') }}</label>
                                                <input type="radio" id="radio-can-add1" name="is_add_fund_fdr" value="0" />
                                                <label for="radio-can-add1">{{ __('Disable') }}</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-6" id="fdr-increase-type">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="switch-field same-type">
                                                <input type="radio" id="increment-unlimited" name="increment_type" checked="" value="unlimited" />
                                                <label for="increment-unlimited">{{ __('Unlimited') }}</label>
                                                <input type="radio" id="increment-fixed" name="increment_type" value="fixed" />
                        ...
                        {{-- FDR Decrease Info section hidden --}}
                        <div class="site-card" style="display: none;">
                            <div class="site-card-header">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="switch-field same-type">
                                                <input type="radio" id="radio-can-deduct" name="is_deduct_fund_fdr" checked="" value="1" />
                                                <label for="radio-can-deduct">{{ __('Enable') }}</label>
                                                <input type="radio" id="radio-can-deduct1" name="is_deduct_fund_fdr" value="0" />
                                                <label for="radio-can-deduct1">{{ __('Disable') }}</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6" id="fdr-decrease-type">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="switch-field same-type">
                                                <input type="radio" id="decrement-unlimited" name="decrement_type" checked="" value="unlimited" />
                                                <label for="decrement-unlimited">{{ __('Unlimited') }}</label>
                                                <input type="radio" id="decrement-fixed" name="decrement_type" value="fixed" />
