...
<div class="main-content">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-xl-8">
                <form action="{{route('admin.plan.dps.update',$plan->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="site-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <input type="text" name="name" class="box-input" placeholder="Plan name" value="{{ $plan->name }}" required />
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="number" name="interval" class="form-control" value="{{ $plan->interval }}"/>
                                ...
                                <div class="col-xl-6 schema-name">
                                    <div class="site-input-groups">
                                        ...
                                        <input type="number" id="total_installment" name="total_installment" value="{{ $plan->total_installment }}" class="box-input" required />
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="number"  id="per_installment" name="per_installment" class="form-control" value="{{ $plan->per_installment }}"/>
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="number" id="interest_rate" name="interest_rate" class="form-control" value="{{ $plan->interest_rate }}"/>
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="text" id="total_deposit" name="total_deposit" class="form-control" value="{{ $plan->total_deposit }}" readonly/>
                                            <span class="input-group-text">{{ setting('site_currency','global') }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="text" id="user_profit" name="user_profit" class="form-control" value="{{ $plan->user_profit }}" readonly/>
                                            <span class="input-group-text">{{ setting('site_currency','global') }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="text" id="total_mature_amount" name="total_mature_amount" class="form-control" value="{{ $plan->total_mature_amount }}" readonly/>
                                            <span class="input-group-text">{{ setting('site_currency','global') }}</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="site-input-groups">
                                        ...
                                        <div class="position-relative">
                                            <input type="number" class="box-input" name="charge"
                                                oninput="this.value = validateDouble(this.value)" value="{{ $plan->charge }}"/>
                                            <div class="prcntcurr">
                                                <select name="charge_type" class="form-select" id="">
                                                    <option value="percentage" @selected($plan->charge_type == 'percentage')>{{ __('%') }}</option>
                                                    <option value="fixed" @selected($plan->charge_type == 'fixed')>{{ $currencySymbol }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-6" id="maturity-platform-fee-sec">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="text"  name="maturity_platform_fee" oninput="this.value = validateDouble(this.value)" class="form-control" value="{{ $plan->maturity_platform_fee }}" />
                                            <span class="input-group-text">{{ setting('site_currency','global') }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="switch-field same-type">
                                            ...
                                            <label for="radio-can-cancel">{{ __('Enable') }}</label>
                                            <input type="radio" id="radio-can-cancel1" name="can_cancel" @checked(!$plan->can_cancel) value="0" />
                                            <label for="radio-can-cancel1">{{ __('Disable') }}</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="switch-field same-type">
                                            <input type="radio" id="radio-can-is_upgrade" name="is_upgrade" @checked($plan->is_upgrade) value="1" />
                                            <label for="radio-can-is_upgrade">{{ __('Enable') }}</label>
                                            <input type="radio" id="radio-can-is_upgrade1" name="is_upgrade" @checked(!$plan->is_upgrade) value="0" />
                                            <label for="radio-can-is_upgrade1">{{ __('Disable') }}</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6" id="increase_type">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="switch-field same-type">
                                            <input type="radio" id="radio-unlimited" name="increment_type" @checked($plan->increment_type == 'unlimited') value="unlimited" />
                                            <label for="radio-unlimited">{{ __('Unlimited') }}</label>
                                            <input type="radio" id="radio-fixed" name="increment_type" @checked($plan->increment_type == 'fixed') value="fixed" />
                                ...
                                <div class="col-xl-6" id="increase_time">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="number" name="increment_times" class="form-control" value="{{ $plan->increment_times }}"/>
                                ...
                                <div class="col-xl-6" id="dps-min-increase-amount">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="text" name="min_increment" value="{{ $plan->min_increment_amount }}"
                                    ...
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="text" name="increment_fee"
                                                oninput="this.value = validateDouble(this.value)" value="{{ $plan->increment_fee }}"
                                                class="form-control"/>
                                            <span
                                                class="input-group-text">{{ setting('site_currency','global') }}</span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="switch-field same-type">
                                            <input type="radio" id="radio-can-is_downgrade" name="is_downgrade" @checked($plan->is_downgrade) value="1" />
                                            <label for="radio-can-is_downgrade">{{ __('Enable') }}</label>
                                            <input type="radio" id="radio-can-is_downgrade1" name="is_downgrade" @checked(!$plan->is_downgrade) value="0" />
                                            <label for="radio-can-is_downgrade1">{{ __('Disable') }}</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6" id="decrease_type">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="switch-field same-type">
                                            <input type="radio" id="radio-decrease-unlimited" name="decrement_type" @checked($plan->decrement_type == 'unlimited') value="unlimited" />
                                            <label for="radio-decrease-unlimited">{{ __('Unlimited') }}</label>
                                            <input type="radio" id="radio-decrease-fixed" name="decrement_type" value="fixed" @checked($plan->decrement_type == 'fixed')/>
                                ...
                                <div class="col-xl-6" id="decrease_time">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="number" name="decrement_times" class="form-control" value="{{ $plan->decrement_times }}"/>
                                            <span class="input-group-text">{{ __('Times') }}</span>
                                    ...
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="text" name="min_decrement"
                                                oninput="this.value = validateDouble(this.value)" value="{{ $plan->min_decrement_amount }}"
                                                class="form-control"/>
                                            <span
                                                class="input-group-text">{{ setting('site_currency','global') }}</span>
                                        </div>
                                    ...
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="text" name="decrement_fee"
                                                oninput="this.value = validateDouble(this.value)" value="{{ $plan->decrement_fee }}"
                                                class="form-control"/>
                                            <span
                                                class="input-group-text">{{ setting('site_currency','global') }}</span>
                                        </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="switch-field same-type">
                                            ...
                                            <label for="radio-can-featured">{{ __('Enable') }}</label>
                                            <input type="radio" id="radio-can-featured1" name="featured" @checked(!$plan->featured) value="0" />
                                            <label for="radio-can-featured1">{{ __('Disable') }}</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="switch-field same-type">
                                            <input type="radio" id="radio-five" name="status" @checked($plan->status) value="1" />
                                            <label for="radio-five">{{ __('Enable') }}</label>
                                            <input type="radio" id="radio-six" name="status" value="0" @checked(!$plan->status)/>
                                            <label for="radio-six">{{ __('Disable') }}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
