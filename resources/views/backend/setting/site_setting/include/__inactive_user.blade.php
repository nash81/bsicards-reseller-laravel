                ...
                <div class="col-sm-8">
                    <div class="form-switch ps-0">
                        <div class="switch-field same-type m-0">
                            ...
                            <label for="active1-yes">{{ __('Enable') }}</label>
                            ...
                            <label for="disable0-no">{{ __('Disable') }}</label>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-8">
                    <div class="form-switch ps-0">
                        <div class="switch-field same-type m-0">
                            ...
                            <label for="active1-yes1">{{ __('Enable') }}</label>
                            ...
                            <label for="disable0-no1">{{ __('Disable') }}</label>
                        </div>
                    </div>
                </div>
            </div>
