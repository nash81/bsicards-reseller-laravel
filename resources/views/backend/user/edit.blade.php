            ...
            <div class="row justify-content-center">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="admin-user-balance-card">
                                            ...
                                            <div class="wallet-info">
                                                <div class="balance">{{ setting('currency_symbol','global') . ' ' . number_format($user->balance, 2) . ' ' . setting('site_currency','global') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6" style="display:none;">
                            <div class="data-card">
                                <div class="icon"><i data-lucide="archive"></i></div>
                                <div class="content">
                    ...
                    <div class="site-tab-bars">
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            {{-- Paybacks, DPS, FDR, Loan tabs hidden --}}
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        {{-- Earnings/Paybacks, DPS, FDR, Loan sections hidden --}}
