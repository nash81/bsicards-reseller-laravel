    ...
    <div class="nav-wrap">
        <div class="nav-left">
            <div class="single-left">
                <div class="site-sidebar-toggle"><i data-lucide="menu"></i></div>
                <div class="salutation"><strong>{{ auth()->user()->full_name }}</strong></div>
            </div>
        </div>
        <div class="nav-right">
            <div class="single-right">
                <div class="dropdown theme-switch-dropdown">
                    <button class="theme-switch-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i data-lucide="sun-moon"></i>
                        <span>{{ __('Theme') }}</span>
                    </button>
                    <ul class="dropdown-menu theme-switch-menu">
                        <li>
                            <button type="button" class="dropdown-item theme-mode-option" data-theme="light">
                                <i data-lucide="sun"></i><span>{{ __('Light') }}</span>
                            </button>
                        </li>
                        <li>
                            <button type="button" class="dropdown-item theme-mode-option" data-theme="dark">
                                <i data-lucide="moon"></i><span>{{ __('Dark') }}</span>
                            </button>
                        </li>
                    </ul>
                </div>
            ...
            <div class="single-right mob-650-none">
                <div class="help-support">
                    <a href="{{ route('user.ticket.index') }}" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-placement="bottom" data-bs-title="Help and Support"><i data-lucide="help-circle"></i></a>
                </div>
            </div>
            <div class="single-right">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a class="dropdown-item logout" href="{{ url('logout') }}" onclick="event.preventDefault();$('#logout-form').submit();"><i data-lucide="log-out"></i><span>{{ __('Logout') }}</span></a>
                                </li>
