...
@section('content')
        ...
        <div class="col-xl-12">
            <div class="site-card">
                <div class="site-card-header">
                    <h3 class="title-small">{{ __('My Ticket List') }}</h3>
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="" class="form-label">{{ __('Subject') }}<span class="required">*</span></label>
                                            <input type="text" class="form-control" name="title" required />
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="" class="form-label">{{ __('Precedence') }}<span class="required">*</span></label>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="" class="form-label">{{ __('Your Message') }}<span class="required">*</span></label>
    ...
    <script>
        ...
        $('#openTicket').on('shown.bs.modal', function () {
            lucide.createIcons();
        });
