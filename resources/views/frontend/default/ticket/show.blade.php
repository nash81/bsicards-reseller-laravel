...
@section('content')
                    ...
                    <div class="site-card">
                        <div class="site-card-header">
                            ...
                            <div class="card-header-links">
                                @if($ticket->isOpen())
                                <button type="button" class="card-header-link bg-danger" data-bs-toggle="modal" data-bs-target="#closeTicket">
                                    <i data-lucide="x"></i> {{ __('Close Ticket') }}
                                </button>
                                @else
                                <button type="button" class="card-header-link" data-bs-toggle="modal" data-bs-target="#reopenTicket">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12">
                                            <div class="form-group">
                                                <textarea class="form-control" name="message" rows="6" placeholder="Write Reply" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                            <div class="add-attachment">
                                                <a href="javascript:void(0)" onclick="addNewAttachment()">
                                                    <i data-lucide="plus-circle"></i>{{ __('Add') }}
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="support-ticket-single-message @if($message->model == 'admin') admin @else user @endif">
                                <div class="logo">
                                    @if( $message->model != 'admin')
                                        <img src="{{ asset($ticket->user->avatar ?? 'global/materials/user.png' )}}" alt="" height="40" width="40">
                                    @else
                                        <img src="{{ asset($message->user->avatar ?? 'global/materials/user.png' )}}" alt="" height="40" width="40">
                                    @endif
                                </div>
                                @if($message->model == 'admin')
                ...
                <div class="modal-body popup-body">
                    ...
                    <div class="popup-body-text centered">
                        ...
                        <div class="action-btns">
                            <a href="{{ route('user.ticket.close.now',$ticket->uuid) }}" class="site-btn-sm primary-btn me-2">
                                <i data-lucide="check"></i> {{ __('Confirm') }}
                            </a>
            ...
            <div class="modal-content site-table-modal">
                <div class="modal-body popup-body">
                    ...
                    <div class="popup-body-text centered">
                        ...
                        <div class="action-btns">
                            <a href="{{ route('user.ticket.show',['uuid' => $ticket->uuid,'action' => 'reopen']) }}" class="site-btn-sm primary-btn me-2">
                                <i data-lucide="check"></i> {{ __('Confirm') }}
                            </a>
                            <button type="button" class="site-btn-sm red-btn" data-bs-dismiss="modal" aria-label="Close">
                                <i data-lucide="x"></i> {{ __('Cancel') }}
    ...
    <script>
        ...
        $('#closeTicket, #reopenTicket').on('shown.bs.modal', function () {
            lucide.createIcons();
        });
