    ...
    <div class="row">
        <div class="col-xl-4 col-lg-12 col-md-12 col-12">
            <div class="user-profile-card">
                ...
                <h3 class="acc-balance">
                    {{ setting('currency_symbol','global').number_format($user->balance,2) }}
                </h3>

                <div class="acc-num">
                    <span class="text-muted small mr-1">A/C:</span>
                    <strong>{{ auth()->user()->account_number }}</strong>
                    <span id="copy" class="ms-2 cursor-pointer" data-bs-toggle="tooltip" data-bs-custom-class="custom-tooltip" data-bs-placement="right" data-bs-title="Copy"><i data-lucide="copy" class="size-4"></i></span>
                </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="site-card">
                <div class="site-card-header">
                    <h4 class="title-small">{{ __('Recent Transactions') }}</h4>
                    <a href="{{ route('user.transactions') }}" class="card-header-link">
                        {{ __('See All') }}
                    ...
                    <div class="site-custom-table">
                        <div class="contents">
                            ...
                            <div class="site-table-list">
                                <div class="site-table-col" data-label="{{ __('Description') }}">
                                ...
                                <div class="site-table-col" data-label="{{ __('Transactions ID') }}">
                                    <div class="trx fw-bold">{{ $transaction->tnx }}</div>
                                </div>
                                <div class="site-table-col" data-label="{{ __('Type') }}">
                                    <div class="type site-badge badge-primary">{{ ucfirst(str_replace('_',' ',$transaction->type->value)) }}</div>
                                </div>
                                <div class="site-table-col" data-label="{{ __('Amount') }}">
                                    <div @class([
                                        "fw-bold amount",
                                ...
                                <div class="site-table-col" data-label="{{ __('Charge') }}">
                                    <div class="fw-bold red-color">-{{ $transaction->charge.' '.$currency }}</div>
                                </div>
                                <div class="site-table-col" data-label="{{ __('Status') }}">
                                ...
                                <div class="site-table-col" data-label="{{ __('Method') }}">
