            ...
            <div class="site-card-body fst-normal fs-6">
                ...
                <div class="step-details-form">
                    ...
                    <form action="{{ route('user.setting.action-2fa') }}" method="POST">
                        ...
                        @if($user->two_fa)
                            <button type="submit" class="site-btn red-btn" value="disable" name="status">
                                <i data-lucide="x-circle"></i> {{ __('Disable 2FA') }}
                            </button>
                        @else
                            <button type="submit" class="site-btn primary-btn" value="enable" name="status">
    ...
    <div class="col-xl-6 col-lg-6 col-md-12">
        <div class="site-card">
            ...
            <div class="site-card-body">
                ...
                <button class="site-btn-sm primary-btn mt-2" data-bs-toggle="modal" data-bs-target="#generatePcode">
                ...
                <button class="site-btn-sm primary-btn mt-2" data-bs-toggle="modal" data-bs-target="#changePasscode">
                            ...
                            <div class="step-details-form">
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="" class="form-label">{{ __('Passcode') }}<span class="required">*</span></label>
                                            <input type="text" class="form-control" minlength="4" maxlength="10" name="passcode" required>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="" class="form-label">{{ __('Confirm Passcode') }}<span class="required">*</span></label>
                                            <input type="text" class="form-control" minlength="4" maxlength="10" name="passcode_confirmation" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('user.setting.change.passcode') }}" method="POST">
                            ...
                            <div class="step-details-form">
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="" class="form-label">{{ __('Old Passcode') }}<span class="required">*</span></label>
                                            <input type="number" class="form-control" minlength="4" maxlength="10" name="old_passcode" required>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="" class="form-label">{{ __('New Passcode') }}<span class="required">*</span></label>
                                            <input type="number" class="form-control" minlength="4" maxlength="10" name="passcode" required>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="" class="form-label">{{ __('Confirm Passcode') }}<span class="required">*</span></label>
                                            <input type="number" class="form-control" minlength="4" maxlength="10" name="passcode_confirmation" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('user.setting.passcode') }}" method="POST">
                            ...
                            <div class="step-details-form">
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <label for="" class="form-label">{{ __('Password') }}<span class="required">*</span></label>
